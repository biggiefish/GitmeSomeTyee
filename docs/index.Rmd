...
kable(recent.summary,
  ...
  column_spec(c(3,10,17), bold = TRUE) %>%
...
Looks like I need to try to get on Randy Killoran or Mike Stutzel's boats. If you guys see this, I would love to get out for a tide! A total of `r stutz$all.fish[stutz$Decade == 2020]` fish have been registered since 2020, or which Mike Stutzel has captured `r stutz$stutz[stutz$Decade == 2020]*stutz$all.fish[stutz$Decade == 2020]` or `r label_percent()(stutz$stutz[stutz$Decade == 2020])`. In the current dataset, nobody has stats like that! Randy caught (rowed or angled) the most fish in the 2000's (n = 23 of 384 registered) and 2010's (n = 15 of 268 registered), but his fish represent `r label_percent()(23/384)` of the total catch in each decade. 
