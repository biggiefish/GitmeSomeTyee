...
#  - plot number of undersize relative to tyee. calculate mean proportion of undersize fish caught for each Tyee.
...
```
**`r fig_nums("grid.arrange(cum.p1, cum.p2, cum.p3)", "Cumulative tally of Tyee's captured by decade. Note that values for 2023 are incomplete and only current to August 15, 2023.")`**

 

### 2.3 Proportion of Tyee Salmon relative to undersive fish.

How many fish < 30 lbs are captured during each season?
...
### 2.4 Does fish size vary within or between seasons?
