...
A quick look at `r fig_nums("plot1", display = "cite")` shows:
  ...
  * Based on available age data, it seems most fish returning to Campbell River are Age 4 or Age 5, with very few Age 6 fish. Given their size you would expect Tyee's to        primarily be at least Age 5. Assuming there is a strong genetic component to spawner age, and that Tyee's are at least Age-5, it is possible that the 4-year cycle is a      carry-over effect from increased juvenile success 5 or 6 years before the 4 year peak.    
...
ADD ESCAPEMENT OF OTHER SPECIES. IS THERE A LULL in year before 4-year cylce peaks?
...
## What else could be affecting returns and catches?
