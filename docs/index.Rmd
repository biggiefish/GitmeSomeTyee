...
Let's have a look at who has been catching the most fish! 
...
```{r, table2 member.summary table, echo = FALSE}
kable(member.summary.top,
      "html",
      booktabs = T,
      align = c("c"),
      col.names = c("Member", "Rank","(Rowed + Angled)", "2000's", "2010's", "2020's", "Total", "2000's", "2010's", "2020's", "Total"),
      caption = "Table 2. Number of fish captured and rowed by anglers and guides who have caught more than 5 Tyee, per decade since 2002.") %>%
  column_spec(c(3,7,11), bold = TRUE) %>%
...
kable(member.summary.bottom,
      ...
      align = c("c"),
      col.names = c("Member", "Rank","(Rowed + Angled)", "2000's", "2010's", "2020's", "Total", "2000's", "2010's", "2020's", "Total"),
      caption = "Table 2. Number of fish captured and rowed by anglers and guides who have caught less than 5 Tyee, per decade since 2002.") %>%
  column_spec(c(3,7,11), bold = TRUE) %>%
  kable_styling("striped", full_width =  FALSE,
                position = "left", 
                font_size = 12,
