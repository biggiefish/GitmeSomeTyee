...
```{r plot flow vs catches, include = FALSE}
## Prepare plot    
library(egg)
flow.plot <-    ggplot(flow.catch.recent) +
...
```{r plot_flow,  fig.dim = c(8,20), fig.cap = "Figure 3. Catches of Tyee Salmon relative to flow in the Campebll River.", echo=FALSE}
suppressWarnings(print(flow.plot))
```